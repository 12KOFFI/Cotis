...
export default function PhoneMock() {
  return (
    <div className="relative mx-auto w-[240px] max-[360px]:w-[220px] sm:w-[320px]">
      ...
      {/* Flottant Gauche: Dernier versement */}
      <motion.div
        animate={{ y: [0, -10, 0] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        className="absolute -left-12 top-[60%] z-30 hidden sm:flex items-center gap-2 rounded-2xl bg-white p-3 shadow-xl ring-1 ring-slate-100 w-[170px]"
      >
        <div className="h-9 w-9 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0">
          <HandCoins className="h-5 w-5" />
        </div>
        <div className="min-w-0">
          <p className="text-[9px] uppercase font-bold text-slate-400 truncate">
            Dernier versement
          </p>
          <p className="text-xs font-black text-slate-800 truncate">+50 000 FCFA</p>
        </div>
      </motion.div>

      {/* Flottant Droite: Sécurité */}
      <motion.div
        animate={{ y: [0, 10, 0] }}
        transition={{ duration: 4, delay: 1.5, repeat: Infinity, ease: "easeInOut" }}
        className="absolute -right-12 top-[25%] z-30 hidden md:flex items-center gap-2 rounded-2xl bg-white p-3 shadow-xl ring-1 ring-slate-100 w-[170px]"
      >
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs font-black text-slate-800 truncate">100% Automatique</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="relative rounded-[2.5rem] bg-slate-900 p-2 shadow-[0_40px_100px_-20px_rgba(15,23,42,0.4)] sm:rounded-[3rem] sm:p-3">
          ...
          <div className="overflow-hidden rounded-[2rem] bg-slate-50 sm:rounded-[2.2rem]">
            {/* Header de l'App */}
            <div className="wave-bg relative px-3 pb-6 pt-10 text-white sm:px-5 sm:pb-8 sm:pt-12">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-2">
                  <motion.span
                    ...
                    className="font-display text-[26px] font-black sm:text-4xl"
                  >
                    850 000
                  </motion.span>
